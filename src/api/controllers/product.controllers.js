...
export const createProduct =  async (req, res)=>{
    try{
        ...
        let [rows] = await productModels.insertProduct(nombre,img_url, tipo, precio);
        console.log(rows);
        res.status(201).json({
...
export const modifyProduct =  async(req,res)=>{
    try{
        ...
        let [result] = await productModels.updateProduct(nombre,img_url,tipo,precio,activo,id);
        console.log(result);
